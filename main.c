        ...
        if(!RX9D && !OERR && !FERR) {   // если нет ошибок
            ...
            if ( c  == 0x0d || c  == 0x0a ) { //введен символ конца строки или возврат каретки
                ...
                if (a[0]=='A' && a[1]=='T') { //если это комманда, то обрабатываем   
                    ...
                    if (a[2]==' ' && a[3]=='T' && a[4]=='\0') { //AT 1\0  - текущая температура
                    ...
                    if (a[2]==' ' && a[3]=='D' && a[4]=='\0') { //AT 2\0 - миимальная темп
                        printf("%d|%d|%d|%d|%d\r\n", obratka_xolodnaya, peregrev, ventil, elektro, nasos );
                        //print_to_uart("2\n");
                    };
                    /*
                    if (a[2]==' ' && a[3]=='3' && a[4]=='\0') { //AT 3\0 - максимальная темп
                        print_to_uart("3\n");
                    };
                    if (a[2]==' ' && a[3]=='4' && a[4]=='\0') { //AT 4\0 Сброс мин и макс
                        print_to_uart("4\n");
                    };
                    */
                }; 
